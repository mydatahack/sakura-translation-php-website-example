...
function name_validation($str){
    // used regular expression match to find only alphabetic characters.
...
function company_validation($str){
    // used regular expression match to find alphanumeric characters and space if applicable.
...
function email_validation($str){
    // used regular expression match to find @ in the string.s
