...
<head>
    ...
    <title> <?php echo TITLE ?></title> <!-- getting the title defined by php code for the page -->
    <link rel = "stylesheet" href = "style/main.css"/> 
    <link rel = "stylesheet" href = "<?php echo Style ?>"/> <!-- getting the stylesheet defined by php code for the page -->
    <?php 
    // import scripts according to the $scripts arraay specified in each page 
